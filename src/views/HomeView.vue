  ...
  <div class="home-container">
    ...
    <div class="fixed-content-layer">
      <transition name="fade" mode="out-in">
        <div :key="currentEra.id" class="main-card">
          <!-- 모바일 이미지 표시 (옵션) -->
          ...
          <div class="action-area">
            <button @click="toggleBooks" class="books-btn">
              <span>
...
.main-card {
  ...
  .action-area {
    ...
    .books-btn {
      ...
      background: linear-gradient(to right, $accent-color, #2563eb);
      color: white;
      font-weight: 600;
      transition: all 0.3s;
      ...
      &:hover {
        background: linear-gradient(to right, darken($accent-color, 5%), darken(#2563eb, 5%));
      }
